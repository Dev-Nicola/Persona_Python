...
class Character:
    # Classe qui définit un personnage dans un jeu daventure
    def __init__(self):
...
class Warrior(Character):
    ...
    def choose_weapon(self):
        # Méthode pour choisir une arme de guerrier
        while True:
            char_weapon = input("Choisissez une arme de guerrier [épée/dague/hache/marteau/massue/bâton] :")
            if char_weapon == "épée":
                print("Vous vous équipez d'une Épée")
                char_weapon = "Épée"
                return char_weapon
            elif char_weapon == "dague":
                print("Vous vous équipez d'une Dague")
                char_weapon = "Dague"
                return char_weapon
            elif char_weapon == "hache":
                print("Vous vous équipez d'une Hache")
                char_weapon = "Hache"
                return char_weapon
            elif char_weapon == "marteau":
                print("Vous vous équipez d'un Marteau")
                char_weapon = "Marteau"
                return char_weapon
            elif char_weapon == "gourdin":
                print("Vous vous équipez d'une Massue")
                char_weapon = "Massue"
                return char_weapon
            elif char_weapon == "bâton":
                print("Vous vous équipez d'un Bâton")
                char_weapon = "Bâton"
                return char_weapon
...
print(char.name, "est un personnage", char.gender, "et est", char.race)
char.display_state()
# Le personnage subit une attaque
print(char.name, "subit une attaque.")
char.hp = char.hp - 20
char.display_state()
